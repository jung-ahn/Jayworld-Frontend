...
export class PostDetailComponent implements OnInit {
  ...
  displayLike(user: User) {
    ...
    if (result) {
      this.like = 'Unlike';  //show dislike as the user clicked like button. so they can dislike .
      this.color = '#e83e8c';
      console.log('testing');
    } else {
      this.like = 'Like';
  ...
  //bug whenever you press like button at the first time, it returns undefined color.
  likePost(post, user) {
    if (this.color == '#000000' || this.color ==undefined) {
      this.color = '#e83e8c';
      this.like = 'Unlike';
